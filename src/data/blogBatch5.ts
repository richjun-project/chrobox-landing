...
export const enBatch5: BlogPostMeta[] = [
  {
    ...
    excerpt: 'Learn how to implement time-boxing in Google Calendar, Apple Calendar, and Outlook — step-by-step instructions for any calendar.',
  ...
  },
  {
    ...
    excerpt: 'Understand the psychology of procrastination and how time-boxing counters it — research-backed strategies to start faster and finish consistently.',
  ...
  },
  {
    ...
    title: 'The Daily Review Ritual: 10 Minutes to Transform Your Day',
    date: '2025-02-28',
    author: 'Chrobox Team',
    category: 'Productivity',
    tags: ['daily-review', 'productivity', 'habits', 'reflection', 'planning'],
    excerpt: 'A structured 10-minute daily review can dramatically improve your focus and output. Learn what to review, when to do it, and how to build the habit.',
  ...
  },
  {
    ...
    title: 'Time-Boxing for Creative Professionals: Structure + Creativity',
    date: '2025-03-03',
    author: 'Chrobox Team',
    category: 'Productivity',
    tags: ['creativity', 'time-boxing', 'creative-work', 'design', 'deep-work'],
    excerpt: 'Many creatives fear rigid schedules stifle inspiration. Discover how time-boxing actually boosts creative output and protects exploration time.',
    image: '/screenshots/en/2.webp',
    readTime: 8,
    lang: 'en',
    faqs: [
