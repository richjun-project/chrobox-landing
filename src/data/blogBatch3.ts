...
export const enBatch3: BlogPostMeta[] = [
  {
    ...
    excerpt: 'Discover how time-boxing turns unproductive meetings into focused, results-driven sessions — practical strategies to reclaim your calendar.',
  ...
  },
  {
    ...
    excerpt: 'Learn how strategic time-boxing sets firm boundaries between work and personal life, reduces burnout, and builds a sustainable schedule.',
  ...
  },
  {
    ...
    excerpt: 'New to productivity? Time-boxing is the perfect starting point. This beginner-friendly guide covers everything you need to get started today.',
  ...
  },
  {
    ...
    excerpt: 'Time-boxing isn\'t just for individuals. Learn how teams use structured time allocation to improve collaboration and cut meeting overhead.',
    image: '/screenshots/en/3.webp',
    readTime: 8,
    lang: 'en',
    faqs: [
